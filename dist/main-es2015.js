...
/* harmony import */ var ngx_electron__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ngx-electron */ "./node_modules/ngx-electron/fesm2015/ngx-electron.js");
/* harmony import */ var ngx_chips__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ngx-chips */ "./node_modules/ngx-chips/fesm2015/ngx-chips.js");
...
let UniversityComponent = class UniversityComponent {
    ...
    delete(list, type) {
        ...
        this.http
            .post("http://localhost:5000/delete", { title: list, type })
            .toPromise()
            .then(res => {
            console.log(res);
            this.http
    ...
    createBlog(blogName, type) {
        this.http
            .post("http://localhost:5000/create", { title: blogName, type })
            .toPromise()
            .then(res => {
            console.log(res);
            this.http
